...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed inset-x-0 bottom-0 z-[100] mx-auto flex w-full max-w-full flex-col gap-2 p-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] sm:right-0 sm:left-auto sm:mx-0 sm:w-auto md:max-w-[420px]",
      className,
    )}
    {...props}
  />
